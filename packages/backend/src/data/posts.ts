...
let posts: Post[] = [
  {
    ...
    content: "This is our first blog post. We're excited to share our thoughts and ideas with you. Stay tuned for more content!",
  ...
  },
  {
    ...
    content: "In this post, we'll explore how to build a modern web API using Bun runtime and Hono framework. Bun provides incredible performance improvements over traditional Node.js applications.",
